...
# Automation-------------------------
def checkDefault():
    print("Which mode you want to use ?")
    print("[ 1 ] Unlimited Mode")
    print("[ 2 ] Limited Mode\n")
    limit_mode = int(input("Enter your choice >> "))
    while True:
        if limit_mode == 1:
            max_limit={"sms":100000,"call":100000,"mail":100000}
            break
        elif limit_mode == 2:
            max_limit={"sms":1000,"call":100,"mail":500}
            break
        else:
...
def pretty_print(cc,target,success,failed):
    ...
    mesgdcrt.SuccessMessage("AttackBox was created by Satya Mishra")
...
try:
    ...
    print("Please run again this attackBox")
...
description="""AttackBox - Your Friendly Spammer Application

AttackBox can be used for many purposes which incudes - 
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

AttackBox is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,epilog='Coded by Satya Mishra !!!')
parser.add_argument("-sms","--sms", action="store_true",help="start AttackBox with SMS Bomb mode")
parser.add_argument("-call","--call", action="store_true",help="start AttackBox with CALL Bomb mode")
parser.add_argument("-mail","--mail", action="store_true",help="start AttackBox with MAIL Bomb mode")
parser.add_argument("-c","--contributors", action="store_true",help="show current AttackBox contributors")
parser.add_argument("-v","--version", action="store_true",help="show current AttackBox version")
